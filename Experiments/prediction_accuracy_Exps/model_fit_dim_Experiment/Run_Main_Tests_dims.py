...
import torch
from Experiments.prediction_accuracy.model_fit_dim_Experiment.Aquisition_sampling import generate_sobol_points
import pfns4bo
from pfns4bo.scripts.acquisition_functions import TransformerBOMethod
from pfns4bo.scripts.tune_input_warping import fit_input_warping
from tqdm import tqdm
from Experiments.prediction_accuracy.model_fit_dim_Experiment.RFF import RFFSampler
from Experiments.prediction_accuracy.model_fit_dim_Experiment.Model_fit_fns import plot_GP_variance_surface, plot_pfn_variance_surface

def main():
    # Save paths
    timestamp = datetime.now().strftime("%Y%m%d_%H%M%S")
    base_save_dir = f"dim_varied_results/run_{timestamp}"
