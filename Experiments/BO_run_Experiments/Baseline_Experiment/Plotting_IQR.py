...
from Experiments.BO_run_Experiments.Baseline_Experiment.pfn_evaluate import eval_pfn
from Experiments.BO_run_Experiments.Baseline_Experiment.Utils import output_standardise
from Experiments.BO_run_Experiments.Baseline_Experiment.Aquisition_sampling import generate_sobol_points
...
def get_training_data(data_dict, dim_idx, method_idx, repeat_idx, iteration):
    """
    ...
    x_init = data_dict["x_init"][dim_idx][method_idx, repeat_idx, :, :]
    
    # Shape: (5 * x_dim, n_fns)
    y_init = data_dict["y_init"][dim_idx][method_idx, repeat_idx, :, :]
    
    # Get queried points
    x_query = data_dict["x_query"][dim_idx][method_idx, repeat_idx, :iteration, :]
    y_true = data_dict["y_true"][dim_idx, method_idx, repeat_idx, :iteration, :]
