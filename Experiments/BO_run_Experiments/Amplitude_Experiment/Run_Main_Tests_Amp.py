...
from Experiments.BO_run_Experiments.Amplitude_Experiment.Experiment_fns import Experiment_GP, Experiment_PFN, Experiment_Random
from Experiments.BO_run_Experiments.Amplitude_Experiment.Aquisition_sampling import generate_sobol_points
import pfns4bo
from pfns4bo.scripts.acquisition_functions import TransformerBOMethod
from tqdm import tqdm
from Experiments.BO_run_Experiments.Amplitude_Experiment.RFF import RFFSampler

def main():
    # Save paths
    timestamp = datetime.now().strftime("%Y%m%d_%H%M%S")
    base_save_dir = f"results_Amp_150/run_{timestamp}"
    ...
    amplitude_store = torch.tensor([amplitudes], device='cpu')
    n_tests = 7
